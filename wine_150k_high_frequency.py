...
data = pd.read_csv('wine-reviews/winemag-data_first150k.csv', encoding='utf-8',
                   usecols=['country', 'designation', 'province', 'region_1', 'region_2', 'variety', 'winery', 'points',
                            'price'])
path = 'fig_150k/high_frequency/'
...
def plot_bar(series, title):
    ...
    plt.savefig('fig_150k/high_frequency/Bar_for_' + title + '_in_wine_reviews_150k.jpg')
